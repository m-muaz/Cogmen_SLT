...
class Dataset:
    def __init__(self, samples, args) -> None:
        ...
        self.dataset_embeddings_dims = args.dataset_embedding_dims
        self.dataset = args.dataset
        self.modalities = args.student_modality
        self.embedding_dim = self.dataset_embeddings_dims[self.dataset][self.modalities]

    def _update_modalities(self, modalities):
